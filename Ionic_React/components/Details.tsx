import { IonCard, IonCardHeader, IonCardTitle, IonContent, IonHeader, IonGrid, IonTitle, IonToolbar, IonRow, IonCol, IonButton } from "@ionic/react";
        ...
        <IonRow>
          <IonCol>
            <IonCard>
              ...
              <IonButton onClick={(e) => {
                history.push("/setimage/" + avion.idAvion)
              }}>Changer la photo</IonButton>
            </IonCard>
          </IonCol>
